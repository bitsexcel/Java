...
public class StreamExample
{
    public static void main(String[] args)
        throws Exception
    {
    	final Logger logger = Logger.getLogger(StreamExample.class);
        byte[] keyBytes = Hex.decode("000102030405060708090a0b0c0d0e0f"
                                   + "000102030405060708090a0b0c0d0e0f");
        logger.info("Hex.toHexString: " +Hex.toHexString(keyBytes));
        ...
        byte[] input = Hex.decode("a0a1a2a3a4a5a6a7a0a1a2a3a4a5a6a7"
                                + "a0a1a2a3a4a5a6a7a0");
        logger.info("Hex.toHexString: " +Hex.toHexString(input));
