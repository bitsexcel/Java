package ch13.lattice.net.sf.ntru.demo;

import java.util.Arrays;
import javax.crypto.*;
import javax.crypto.spec.*;
import ch13.lattice.net.sf.ntru.encrypt.*;

public class ExampleOf_AES_NTRU 
{   
    
    public static void main(String[] args) throws Exception 
    {
        new ExampleOf_AES_NTRU().ExecuteNTRUEncryptionDecryptionProcess();
    }
    
    private void ExecuteNTRUEncryptionDecryptionProcess() throws Exception 
    {
        String message = "Welcome to Apress. Enjoy learning " + 
        ...
        // setup a NTRU instance based on the encryption parameters
    ...
    private byte[] generate_byte_array(byte[] byteArray1, byte[] byteArray2) 
    {
        ...
        // return the third byte array containing the result of concatenation
        return byteArray3;
    }
}